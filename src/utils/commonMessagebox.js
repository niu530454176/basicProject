...
export function MessageError(text = '请求失败，请重试') {
    Message({
        message: text,
        type: 'error',
...
export function MesssageBoxAlert(text = 'Box询问') {
...
export function MesssageBoxQuestion(text = 'Box询问', obj) {
    return MessageBox.confirm(text, '提示', {
        confirmButtonText: typeof obj === 'object' ? obj.confirmButtonText : '确定',
        distinguishCancelAndClose: true,
        cancelButtonClass: 'btn-custom-cancel',
        dangerouslyUseHTMLString: true,
        cancelButtonText: typeof obj === 'object' ? obj.cancelButtonText : '取消',
        type: 'warning'
    })
}
...
export function transformMap (option) {
    let str = {};
    option.forEach(item => {
...
_common = {
    ...
    MesssageBoxAlert: MesssageBoxAlert,
